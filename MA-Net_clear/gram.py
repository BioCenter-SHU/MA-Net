...
def main(frame_path, video_path, video_name, clip):
    ...
    # 加载预训练权重
    # CS
    pretrained_dict = torch.load('checkpoint/resnet50/CS/resnet50_30/2022-12-07-11-24-15/resnet50_30/clip_len_30_0_checkpoint.pth.tar', map_location='cpu')
    # res4
    # pretrained_dict = torch.load('checkpoint/res/res4/resnet50_30/2022-12-15-18-27-28/resnet50_30/clip_len_30_0_checkpoint.pth.tar', map_location='cpu')
    ...
    # 设置保存路径
    save_path = 'visualization/res4/{}'.format(video_name)

...
class Action(nn.Module):
    def __init__(self, net, n_segment=3, shift_div=8):
        ...
        # keyframe attention
        self.kf_conv1 = nn.Conv2d(self.in_channels, self.in_channels // 2, kernel_size=(1, 1), stride=(1, 1), bias=False, padding=(0, 0))
        ...
        print('====USE keyframe 3 CS method 5_2 Block====')
    ...
    def forward(self, x):
        ...
        x_kf = x_kf.view(n_batch, self.n_segment, self.in_channels // 2, h, w)
